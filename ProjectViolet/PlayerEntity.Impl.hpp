...
PlayerEntity::PlayerEntity() :Mob() {
	...
	setData("12item_name", "item_arrow"s);
	setData("12count", 64);
	...
	setData("15item_name", "item_emx3_ammo"s);
	setData("15count", 6);
	setData("16item_name", "item_vtx65_ammo"s);
	setData("16count", 6);
	setData("17item_name", "item_mrm36_ammo"s);
	setData("17count", 4);
	setData("18item_name", "item_sg55_ammo"s);
	setData("18count", 8);

	setData("20item_name", "item_grenade"s);
	setData("20count", 8);
